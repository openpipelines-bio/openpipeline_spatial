// from_h5mu_to_spatialdata build_bump_spatialdata
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/convert/from_h5mu_to_spatialdata/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'input_spatialdata': $( if [ ! -z ${VIASH_PAR_INPUT_SPATIALDATA+x} ]; then echo "r'${VIASH_PAR_INPUT_SPATIALDATA//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/convert/from_h5mu_to_spatialdata",
