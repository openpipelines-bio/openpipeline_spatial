// from_cosmx_to_spatialexperiment build_bump_spatialdata
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/convert/from_cosmx_to_spatialexperiment/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  ...
  "add_tx_path" = $( if [ ! -z ${VIASH_PAR_ADD_TX_PATH+x} ]; then echo -n "as.logical(toupper('"; echo -n "$VIASH_PAR_ADD_TX_PATH" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'))"; else echo NULL; fi ),
  "add_polygon_path" = $( if [ ! -z ${VIASH_PAR_ADD_POLYGON_PATH+x} ]; then echo -n "as.logical(toupper('"; echo -n "$VIASH_PAR_ADD_POLYGON_PATH" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'))"; else echo NULL; fi ),
  "add_fov_positions" = $( if [ ! -z ${VIASH_PAR_ADD_FOV_POSITIONS+x} ]; then echo -n "as.logical(toupper('"; echo -n "$VIASH_PAR_ADD_FOV_POSITIONS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'))"; else echo NULL; fi ),
  "alternative_experiment_features" = $( if [ ! -z ${VIASH_PAR_ALTERNATIVE_EXPERIMENT_FEATURES+x} ]; then echo -n "strsplit('"; echo -n "$VIASH_PAR_ALTERNATIVE_EXPERIMENT_FEATURES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "', split = ';')[[1]]"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/convert/from_cosmx_to_spatialexperiment",
