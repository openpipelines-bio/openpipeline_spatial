// from_xenium_to_spatialexperiment build_bump_spatialdata
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/convert/from_xenium_to_spatialexperiment/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  ...
  "add_experiment_xenium" = $( if [ ! -z ${VIASH_PAR_ADD_EXPERIMENT_XENIUM+x} ]; then echo -n "as.logical(toupper('"; echo -n "$VIASH_PAR_ADD_EXPERIMENT_XENIUM" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'))"; else echo NULL; fi ),
  "add_parquet_paths" = $( if [ ! -z ${VIASH_PAR_ADD_PARQUET_PATHS+x} ]; then echo -n "as.logical(toupper('"; echo -n "$VIASH_PAR_ADD_PARQUET_PATHS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'))"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/convert/from_xenium_to_spatialexperiment",
