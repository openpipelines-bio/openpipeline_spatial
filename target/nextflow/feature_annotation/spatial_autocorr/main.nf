// spatial_autocorr build_bump_spatialdata
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "boolean",
          "name" : "--use_all_genes",
          "description" : "Whether to use all genes even if highly variable genes are present in .var.\nIf set to true, all genes will be used.\n",
          "default" : [
            false
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/feature_annotation/spatial_autocorr/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  ...
  'input_genes': $( if [ ! -z ${VIASH_PAR_INPUT_GENES+x} ]; then echo "r'${VIASH_PAR_INPUT_GENES//\\'/\\'\\"\\'\\"r\\'}'.split(',')"; else echo None; fi ),
  'obsp_neighborhood_graph': $( if [ ! -z ${VIASH_PAR_OBSP_NEIGHBORHOOD_GRAPH+x} ]; then echo "r'${VIASH_PAR_OBSP_NEIGHBORHOOD_GRAPH//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'use_all_genes': $( if [ ! -z ${VIASH_PAR_USE_ALL_GENES+x} ]; then echo "r'${VIASH_PAR_USE_ALL_GENES//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'mode': $( if [ ! -z ${VIASH_PAR_MODE+x} ]; then echo "r'${VIASH_PAR_MODE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'attr': $( if [ ! -z ${VIASH_PAR_ATTR+x} ]; then echo "r'${VIASH_PAR_ATTR//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'n_perms': $( if [ ! -z ${VIASH_PAR_N_PERMS+x} ]; then echo "int(r'${VIASH_PAR_N_PERMS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'use_raw': $( if [ ! -z ${VIASH_PAR_USE_RAW+x} ]; then echo "r'${VIASH_PAR_USE_RAW//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/feature_annotation/spatial_autocorr",
