...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/filter/intersect_obs/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/filter/intersect_obs",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'modalities': $( if [ ! -z ${VIASH_PAR_MODALITIES+x} ]; then echo "r'${VIASH_PAR_MODALITIES//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline/filter/intersect_obs",
    "tag" : "v4.1.0"
  },
  "label" : [
    "lowcpu",
