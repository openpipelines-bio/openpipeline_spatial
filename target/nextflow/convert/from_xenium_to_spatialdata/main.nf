// from_xenium_to_spatialdata build_bump_spatialdata
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/convert/from_xenium_to_spatialdata/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'cells_boundaries': $( if [ ! -z ${VIASH_PAR_CELLS_BOUNDARIES+x} ]; then echo "r'${VIASH_PAR_CELLS_BOUNDARIES//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'nucleus_boundaries': $( if [ ! -z ${VIASH_PAR_NUCLEUS_BOUNDARIES+x} ]; then echo "r'${VIASH_PAR_NUCLEUS_BOUNDARIES//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'cells_as_circles': $( if [ ! -z ${VIASH_PAR_CELLS_AS_CIRCLES+x} ]; then echo "r'${VIASH_PAR_CELLS_AS_CIRCLES//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'cells_labels': $( if [ ! -z ${VIASH_PAR_CELLS_LABELS+x} ]; then echo "r'${VIASH_PAR_CELLS_LABELS//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'transcripts': $( if [ ! -z ${VIASH_PAR_TRANSCRIPTS+x} ]; then echo "r'${VIASH_PAR_TRANSCRIPTS//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'nucleus_labels': $( if [ ! -z ${VIASH_PAR_NUCLEUS_LABELS+x} ]; then echo "r'${VIASH_PAR_NUCLEUS_LABELS//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'morphology_mip': $( if [ ! -z ${VIASH_PAR_MORPHOLOGY_MIP+x} ]; then echo "r'${VIASH_PAR_MORPHOLOGY_MIP//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'morphology_focus': $( if [ ! -z ${VIASH_PAR_MORPHOLOGY_FOCUS+x} ]; then echo "r'${VIASH_PAR_MORPHOLOGY_FOCUS//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'aligned_images': $( if [ ! -z ${VIASH_PAR_ALIGNED_IMAGES+x} ]; then echo "r'${VIASH_PAR_ALIGNED_IMAGES//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'cells_table': $( if [ ! -z ${VIASH_PAR_CELLS_TABLE+x} ]; then echo "r'${VIASH_PAR_CELLS_TABLE//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'n_jobs': $( if [ ! -z ${VIASH_PAR_N_JOBS+x} ]; then echo "int(r'${VIASH_PAR_N_JOBS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/convert/from_xenium_to_spatialdata",
