// from_h5mu_to_spatialexperiment build_bump_spatialdata
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/convert/from_h5mu_to_spatialexperiment/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  ...
  "obsm_spatial_coordinates" = $( if [ ! -z ${VIASH_PAR_OBSM_SPATIAL_COORDINATES+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_OBSM_SPATIAL_COORDINATES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/convert/from_h5mu_to_spatialexperiment",
