// nichecompass_leiden build_bump_spatialdata
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        {
          "type" : "string",
          "name" : "--input_obs_batch_key",
          "description" : "Key of the adata.obs field that contains the batch information.",
          "default" : [
            "sample_id"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          ...
          "description" : "Minimum number of genes in a gene program including both target and source genes that need to be available in the input data (gene expression has been probed) for a gene program not to be discarded.\n",
          "default" : [
            1
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Minimum number of source genes in a gene program that need to be available in the input data (gene expression has been probed) for a gene program not to be discarded.\n",
          "default" : [
            0
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Minimum number of target genes in a gene program that need to be available in the input data (gene expression has been probed) for a gene program not to be discarded.\n",
          "default" : [
            0
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Maximum number of genes in a gene program inluding both target and source genes that can be available in the input data (gene expression has been probed) for a gene program not to be discarded.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          ...
          "description" : "Maximum number of source genes in a gene program that can be available in the input data (gene expression has been probed) for a gene program not to be discarded.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          ...
          "description" : "Maximum number of target genes in a gene program that can be available in the input data (gene expression has been probed) for a gene program not to be discarded.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          ...
          "description" : "Whether to remove the genes that are not in the gp masks from the input data.\n",
          "direction" : "input"
        }
      ]
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/workflows/niche/nichecompass_leiden/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { concatenate_h5mu } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/dataflow/concatenate_h5mu/main.nf"
...
include { split_h5mu } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/dataflow/split_h5mu/main.nf"
include { neighbors_leiden_umap } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/workflows/multiomics/neighbors_leiden_umap/main.nf"
