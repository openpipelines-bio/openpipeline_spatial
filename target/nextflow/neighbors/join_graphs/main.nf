// join_graphs build_bump_spatialdata
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Key in `adata.obsp` containing the expression connectivity matrix.\n",
          "default" : [
            "connectivities"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Key in `adata.obsp` containing the spatial connectivity matrix.\n",
          "default" : [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Key under which to store the fused connectivity matrix in `adata.obsp`.\n",
          "default" : [
            "spatial_expression_connectivities"
          ],
          "required" : false,
          "direction" : "input",
          "multiple" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/neighbors/join_graphs/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/target/nextflow/neighbors/join_graphs",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'input_obsp_expression_graph': $( if [ ! -z ${VIASH_PAR_INPUT_OBSP_EXPRESSION_GRAPH+x} ]; then echo "r'${VIASH_PAR_INPUT_OBSP_EXPRESSION_GRAPH//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_obsp_spatial_graph': $( if [ ! -z ${VIASH_PAR_INPUT_OBSP_SPATIAL_GRAPH+x} ]; then echo "r'${VIASH_PAR_INPUT_OBSP_SPATIAL_GRAPH//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'alpha': $( if [ ! -z ${VIASH_PAR_ALPHA+x} ]; then echo "float(r'${VIASH_PAR_ALPHA//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_obsp_graph': $( if [ ! -z ${VIASH_PAR_OUTPUT_OBSP_GRAPH+x} ]; then echo "r'${VIASH_PAR_OUTPUT_OBSP_GRAPH//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/neighbors/join_graphs",
