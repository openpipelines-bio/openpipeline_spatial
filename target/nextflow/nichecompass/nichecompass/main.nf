// nichecompass build_bump_spatialdata
// 
...
meta = [
  ...
  "version" : "build_bump_spatialdata",
  "authors" : [
    {
      "name" : "Dorien Roosen",
      "roles" : [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--layer",
          "description" : "Input layer containing raw counts to be use. If None, X is used",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--var_input",
          "description" : "Key in adata.var that indicates which features to include as input for the NicheCompass model.\nIf not provided, all features will be included.\n",
          "default" : [
            "filter_with_hvg"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Key in adata.obsp where connectivities of the spatial neighborhood graph are stored",
          "default" : [
      ...
      "arguments" : [
        {
          ...
          "description" : "Minimum number of genes in a gene program including both target and source genes that need to be available in the adata (gene expression has been probed) for a gene program not to be discarded.\n",
          "default" : [
            1
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Minimum number of source genes in a gene program that need to be available in the adata (gene expression has been probed) for a gene program not to be discarded.\n",
          "default" : [
            0
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Minimum number of target genes in a gene program that need to be available in the adata (gene expression has been probed) for a gene program not to be discarded.\n",
          "default" : [
            0
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Maximum number of genes in a gene program including both target and source genes that can be available in the adata (gene expression has been probed) for a gene program not to be discarded.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          ...
          "description" : "Maximum number of source genes in a gene program that can be available in the adata (gene expression has been probed) for a gene program not to be discarded.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          ...
          "description" : "Maximum number of target genes in a gene program that can be available in the adata (gene expression has been probed) for a gene program not to be discarded.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          ...
          "description" : "Whether to remove the genes that are not in the gp masks from the adata object.\n",
          "direction" : "input"
        }
      ]
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "List of VGPGAE modules in which the categorical covariates embeddings are injected.\n",
          "default" : [
            "gene_expr_decoder",
        ...
        },
        {
          ...
          "description" : "Whether to include the edge reconstruction loss in the backpropagation.\n",
          "default" : [
            true
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Whether to include the gene expression reconstruction loss in the backpropagation.\n",
          "default" : [
            true
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Whether to include the categorical covariates contrastive loss in the backpropagation.\n",
          "default" : [
            true
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Whether to transform x by log(x+1) prior to encoding for numerical stability (not for normalization).\n",
          "default" : [
            true
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Number of fully connected layers in the encoder before message passing layers.\n",
          "default" : [
            1
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Number of message passing layers in the encoder.\n",
          "default" : [
            1
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Convolutional layer used as GNN in the encoder.\n",
          "default" : [
            "gatv2conv"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Number of attention heads used in the GNN layers of the encoder.\nOnly relevant if `--conv_layer_encoder gatv2conv`. \n",
          "default" : [
            4
          ],
          "required" : false,
        ...
        },
        {
          "type" : "boolean",
          "name" : "--encoder_use_bn",
          "description" : "Whether to use a batch normalization layer at the end of the encoder to normalize `mu`.\n",
          "default" : [
            false
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Probability that nodes will be dropped in the encoder during training.\n",
          "default" : [
            0.0
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Probability that nodes will be dropped in the graph decoder during training.\n",
          "default" : [
            0.0
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_addon_gp",
          "description" : "Number of addon gene programs (i.e. gene programs that are not included in masks but can be learned de novo).\n",
          "default" : [
            100
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Number of epochs during which all gene programs are used for model training.\nAfter that only active gene programs are retained.\n",
          "default" : [
            25
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Number of epochs during which the edge reconstruction loss is excluded from backpropagation for pretraining using the other loss components.\n",
          "default" : [
            0
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Number of epochs during which the categorical covariates contrastive loss is excluded from backpropagation for pretraining using the other loss components.\n",
          "default" : [
            5
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Lambda (weighting factor) for the group lasso regularization loss of gene programs.\nIf `>0`, this will enforce sparsity of gene programs.\n",
          "default" : [
            0.0
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Lambda (weighting factor) for the L1 regularization loss of genes in masked gene programs.\nIf `>0`, this will enforce sparsity of genes in masked gene programs.\n",
          "default" : [
            0.0
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Gene program mask targets categories for which l1 regularization loss will be applied.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : "Gene program mask sources categories for which l1 regularization loss will be applied.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : "Lambda (weighting factor) for the L1 regularization loss of genes in addon gene programs.\nIf `>0`, this will enforce sparsity of genes in addon gene programs.\n",
          "default" : [
            30.0
          ],
          "required" : false,
        ...
        },
        {
          "type" : "double",
          "name" : "--edge_val_ratio",
          "description" : "Fraction of the data that is used as validation set on edge-level. The rest of the data will be used as training set on edge-level.\n",
          "default" : [
            0.1
          ],
          "required" : false,
        ...
        },
        {
          "type" : "double",
          "name" : "--node_val_ratio",
          "description" : "Fraction of the data that is used as validation set on node-level. The rest of the data will be used as training set on node-level.\n",
          "default" : [
            0.1
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Number of neighbors that are sampled during model training from the spatial neighborhood graph.\nIf set to -1, all direct neighbors are included.\n",
          "default" : [
            -1
          ],
          "required" : false,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Key of the obsm field where the latent / gene program representation of active gene programs will be stored after NicheCompass model training.\n",
          "default" : [
            "nichecompass_latent"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Key of the varm field where the binary gene program mask for target genes of a gene program will be stored (target genes are used for the reconstruction of the gene expression of the node itself (receiving node )).\n",
          "default" : [
        ...
        },
        {
          ...
          "description" : "Key of the varm field where the binary gene program mask for source genes of a gene program will be stored (source genes are used for the reconstruction of the gene expression of the node's neighbors (transmitting nodes)).\n",
          "default" : [
        ...
        },
        {
          ...
          "description" : "Key of the uns field where the gene program names will be stored.\n",
          "default" : [
        ...
        },
        {
          ...
          "description" : "Key of the uns field where the active gene program names will be stored.\n",
          "default" : [
        ...
        },
        {
          ...
          "description" : "Key of the uns field where the index of the target genes that are in the gene program mask will be stored.\n",
          "default" : [
        ...
        },
        {
          ...
          "description" : "Key of the uns field where the index of the source genes that are in the gene program mask will be stored.\n",
          "default" : [
        ...
        },
        {
          ...
          "description" : "Key of the uns fields where the covariate embeddings will be stored.\nNeeds to match the length and order of `--input_obs_covariates`.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : "Key of the obsp field where the reconstructed adjacency matrix edge probabilities will be stored.\n",
          "default" : [
            "nichecompass_recon_connectivities"
          ],
          "required" : false,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          ...
          "description" : "Key of the obsp field where the aggregation weights of the node label aggregator will be stored.\n",
          "default" : [
            "nichecompass_agg_weights"
          ],
          "required" : false,
          "direction" : "input",
          "multiple" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/nichecompass/nichecompass/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/target/nextflow/nichecompass/nichecompass",
    "viash_version" : "0.9.7",
    "git_commit" : "486003bb6b395c85087c26f8a978e2af13486602",
  ...
  "package_config" : {
    ...
    "viash_version" : "0.9.7",
    "source" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src",
    "target" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/target",
    "config_mods" : [
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/nichecompass/nichecompass",
    "tag" : "build_bump_spatialdata"
  },
  "label" : [
    "midcpu",
    "midmem",
