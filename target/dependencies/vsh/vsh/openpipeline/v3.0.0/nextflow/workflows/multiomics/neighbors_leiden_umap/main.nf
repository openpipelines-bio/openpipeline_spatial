...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/workflows/multiomics/neighbors_leiden_umap/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/nextflow/workflows/multiomics/neighbors_leiden_umap",
    "viash_version" : "0.9.4",
