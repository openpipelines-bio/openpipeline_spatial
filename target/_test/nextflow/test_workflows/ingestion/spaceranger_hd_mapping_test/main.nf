// spaceranger_hd_mapping_test build_main
// 
...
meta = [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input",
          "description" : "Path to the SpatialData Zarr output.",
          "example" : [
            "foo.zarr"
          ],
          "must_exist" : true,
  ...
  "description" : "Tests the output of the spaceranger_hd_mapping integration test.",
  "status" : "enabled",
  "scope" : {
    "image" : "test",
    "target" : "test"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/workflows/test_workflows/ingestion/spaceranger_hd_mapping_test/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/test_workflows/ingestion/spaceranger_hd_mapping_test",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
