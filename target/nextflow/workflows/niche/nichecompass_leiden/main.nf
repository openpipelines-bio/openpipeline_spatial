// nichecompass_leiden build_niche_compass
// 
      ...
      "arguments" : [
        {
          ...
          "description" : "Minimum number of genes in a gene program inluding both target and source genes that need to be available in the input data (gene expression has been probed) for a gene program not to be discarded.\n",
          "default" : [
            1
          ],
          "required" : false,
...
include { concatenate_h5mu } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.0.3/nextflow/dataflow/concatenate_h5mu/main.nf"
...
include { split_h5mu } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.0.3/nextflow/dataflow/split_h5mu/main.nf"
include { neighbors_leiden_umap } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.0.3/nextflow/workflows/multiomics/neighbors_leiden_umap/main.nf"
