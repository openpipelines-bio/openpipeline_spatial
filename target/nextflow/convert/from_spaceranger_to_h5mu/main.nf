// from_spaceranger_to_h5mu build_bump_spatialdata
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/convert/from_spaceranger_to_h5mu/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'uns_probe_set': $( if [ ! -z ${VIASH_PAR_UNS_PROBE_SET+x} ]; then echo "r'${VIASH_PAR_UNS_PROBE_SET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/convert/from_spaceranger_to_h5mu",
