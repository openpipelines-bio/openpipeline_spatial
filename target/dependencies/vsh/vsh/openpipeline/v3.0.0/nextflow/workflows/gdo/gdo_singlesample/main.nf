...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/workflows/gdo/gdo_singlesample/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/nextflow/workflows/gdo/gdo_singlesample",
    "viash_version" : "0.9.4",
