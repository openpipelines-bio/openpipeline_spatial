// nichecompass build_niche_compass
// 
...
meta = [
      ...
      "arguments" : [
        {
          ...
          "description" : "Minimum number of genes in a gene program inluding both target and source genes that need to be available in the adata (gene expression has been probed) for a gene program not to be discarded.\n",
          "default" : [
            1
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Maximum number of genes in a gene program inluding both target and source genes that can be available in the adata (gene expression has been probed) for a gene program not to be discarded.\n",
          "required" : false,
          "min" : 1,
          "direction" : "input",
          "multiple" : false,
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.4",
    "git_commit" : "9da21219dafb6daed78560ab8076b75d7e38554a",
