// from_xenium_to_h5mu build_bump_spatialdata
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/convert/from_xenium_to_h5mu/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'uns_experiment': $( if [ ! -z ${VIASH_PAR_UNS_EXPERIMENT+x} ]; then echo "r'${VIASH_PAR_UNS_EXPERIMENT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/convert/from_xenium_to_h5mu",
