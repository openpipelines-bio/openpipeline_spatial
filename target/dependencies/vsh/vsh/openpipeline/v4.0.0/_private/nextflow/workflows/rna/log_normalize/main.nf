...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/workflows/rna/log_normalize/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
