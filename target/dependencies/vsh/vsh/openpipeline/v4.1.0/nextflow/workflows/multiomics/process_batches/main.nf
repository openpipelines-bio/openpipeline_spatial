...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "User-defined list of feature names to exclude from HVG calculation. These features will be excluded from HVG selection but will remain in the output data.\n",
          "example" : [
            "MT-CO1",
            "MT-CO2",
            "MT-ND1"
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/workflows/multiomics/process_batches/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/nextflow/workflows/multiomics/process_batches",
    "viash_version" : "0.9.7",
