...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/transform/log1p/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/transform/log1p",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline/transform/log1p",
    "tag" : "v3.0.0"
  },
  "label" : [
    "midmem",
