// spaceranger_count build_bump_spatialdata
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/mapping/spaceranger_count/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
$( if [ ! -z ${VIASH_PAR_GEX_REFERENCE+x} ]; then echo "${VIASH_PAR_GEX_REFERENCE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_gex_reference='&'#" ; else echo "# par_gex_reference="; fi )
$( if [ ! -z ${VIASH_PAR_INPUT+x} ]; then echo "${VIASH_PAR_INPUT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_input='&'#" ; else echo "# par_input="; fi )
$( if [ ! -z ${VIASH_PAR_PROBE_SET+x} ]; then echo "${VIASH_PAR_PROBE_SET}" | sed "s#'#'\\"'\\"'#g;s#.*#par_probe_set='&'#" ; else echo "# par_probe_set="; fi )
$( if [ ! -z ${VIASH_PAR_CYTAIMAGE+x} ]; then echo "${VIASH_PAR_CYTAIMAGE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_cytaimage='&'#" ; else echo "# par_cytaimage="; fi )
$( if [ ! -z ${VIASH_PAR_IMAGE+x} ]; then echo "${VIASH_PAR_IMAGE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_image='&'#" ; else echo "# par_image="; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "${VIASH_PAR_OUTPUT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_output='&'#" ; else echo "# par_output="; fi )
$( if [ ! -z ${VIASH_PAR_SLIDE+x} ]; then echo "${VIASH_PAR_SLIDE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_slide='&'#" ; else echo "# par_slide="; fi )
$( if [ ! -z ${VIASH_PAR_AREA+x} ]; then echo "${VIASH_PAR_AREA}" | sed "s#'#'\\"'\\"'#g;s#.*#par_area='&'#" ; else echo "# par_area="; fi )
$( if [ ! -z ${VIASH_PAR_UNKNOWN_SLIDE+x} ]; then echo "${VIASH_PAR_UNKNOWN_SLIDE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_unknown_slide='&'#" ; else echo "# par_unknown_slide="; fi )
$( if [ ! -z ${VIASH_PAR_SLIDEFILE+x} ]; then echo "${VIASH_PAR_SLIDEFILE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_slidefile='&'#" ; else echo "# par_slidefile="; fi )
$( if [ ! -z ${VIASH_PAR_OVERRIDE_ID+x} ]; then echo "${VIASH_PAR_OVERRIDE_ID}" | sed "s#'#'\\"'\\"'#g;s#.*#par_override_id='&'#" ; else echo "# par_override_id="; fi )
$( if [ ! -z ${VIASH_PAR_DARKIMAGE+x} ]; then echo "${VIASH_PAR_DARKIMAGE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_darkimage='&'#" ; else echo "# par_darkimage="; fi )
$( if [ ! -z ${VIASH_PAR_COLORIZEDIMAGE+x} ]; then echo "${VIASH_PAR_COLORIZEDIMAGE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_colorizedimage='&'#" ; else echo "# par_colorizedimage="; fi )
