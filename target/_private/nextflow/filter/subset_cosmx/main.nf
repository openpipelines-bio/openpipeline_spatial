// subset_cosmx build_bump_spatialdata
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/filter/subset_cosmx/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'num_fovs': $( if [ ! -z ${VIASH_PAR_NUM_FOVS+x} ]; then echo "int(r'${VIASH_PAR_NUM_FOVS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'subset_transcripts_file': $( if [ ! -z ${VIASH_PAR_SUBSET_TRANSCRIPTS_FILE+x} ]; then echo "r'${VIASH_PAR_SUBSET_TRANSCRIPTS_FILE//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'subset_polygons_file': $( if [ ! -z ${VIASH_PAR_SUBSET_POLYGONS_FILE+x} ]; then echo "r'${VIASH_PAR_SUBSET_POLYGONS_FILE//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
