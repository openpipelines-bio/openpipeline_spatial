// from_h5mu_to_seurat_with_fov build_bump_spatialdata
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Key name of the .obsm slot in the input file that contains the spatial (centroid) coordinates.\n",
          "default" : [
            "spatial"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          ...
          "description" : "Number of sides of the polygon to be created around each centroid coordinate to represent the cell shape.\nIf not provided, circles will be created.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : "Radius of the shape around each centroid coordinate to represent the cell shape.\nIf not provided, Seurat computes a default based on the centroid coordinates.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        },
        {
          "type" : "double",
          "name" : "--centroid_theta",
          "description" : "Angle to adjust the shapes around each centroid when plotting.\nIf not provided, no adjustment will be made (theta = 0)\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--x_mapping",
          "description" : "Name of the Seurat layer in which the AnnData .X matrix is stored.\n",
          "default" : [
            "counts"
          ],
          "required" : false,
  ...
  "description" : "Converts a single modality of an h5mu file into a Seurat object with a Field of View (FOV)\nbuilt from centroid coordinates of spatially-resolved single cells.\n",
  "test_resources" : [
    {
      "type" : "r_script",
      "path" : "test.R",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/convert/from_h5mu_to_seurat_with_fov/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par <- list(
  ...
  "obsm_centroid_coordinates" = $( if [ ! -z ${VIASH_PAR_OBSM_CENTROID_COORDINATES+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_OBSM_CENTROID_COORDINATES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "centroid_nsides" = $( if [ ! -z ${VIASH_PAR_CENTROID_NSIDES+x} ]; then echo -n "as.integer('"; echo -n "$VIASH_PAR_CENTROID_NSIDES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "centroid_radius" = $( if [ ! -z ${VIASH_PAR_CENTROID_RADIUS+x} ]; then echo -n "as.numeric('"; echo -n "$VIASH_PAR_CENTROID_RADIUS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
  "centroid_theta" = $( if [ ! -z ${VIASH_PAR_CENTROID_THETA+x} ]; then echo -n "as.numeric('"; echo -n "$VIASH_PAR_CENTROID_THETA" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "')"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/convert/from_h5mu_to_seurat_with_fov",
