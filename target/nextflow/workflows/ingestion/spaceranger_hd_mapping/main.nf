// spaceranger_hd_mapping build_main
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--probe_set",
          "description" : "CSV file specifying the probe set used. Omit for Visium HD 3' data\n(sequencing-based); provide it only for probe-based Visium HD.\n",
          "example" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--cytaimage",
          "description" : "Brightfield image generated by the CytAssist instrument. Required for\nVisium HD.\n",
          "example" : [
            "cytassist.tiff"
          ],
          "must_exist" : true,
        ...
        },
        {
          "type" : "file",
          "name" : "--image",
          "description" : "H&E microscope image (TIFF or JPG). Required to run nucleus/cell\nsegmentation.\n",
          "example" : [
            "brightfield.tif"
          ],
          "must_exist" : true,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--dataset_id",
          "description" : "Identifier used to name the spatial elements. Defaults to the sample id.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
  ...
  "info" : {
    ...
    "test_dependencies" : [
      {
        "name" : "spaceranger_hd_mapping_test",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/workflows/ingestion/spaceranger_hd_mapping/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { spaceranger_count } from "${meta.resources_dir}/../../../../nextflow/mapping/spaceranger_count/main.nf"
include { from_spaceranger_hd_to_spatialdata } from "${meta.resources_dir}/../../../../nextflow/convert/from_spaceranger_hd_to_spatialdata/main.nf"
