...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/workflows/prot/prot_singlesample/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/nextflow/workflows/prot/prot_singlesample",
    "viash_version" : "0.9.4",
