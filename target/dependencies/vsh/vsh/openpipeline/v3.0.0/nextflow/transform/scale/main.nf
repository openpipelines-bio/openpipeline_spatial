...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/transform/scale/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/transform/scale",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline/transform/scale",
    "tag" : "v3.0.0"
  },
  "label" : [
    "lowmem",
