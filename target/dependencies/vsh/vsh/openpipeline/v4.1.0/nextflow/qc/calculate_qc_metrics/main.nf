      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input",
          "description" : "Input data. Can be encoded in H5 or Zarr (v3) format.",
          "example" : [
            "input.h5mu"
          ],
          "must_exist" : true,
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--output",
          "description" : "Output data. Can be encoded using H5 or Zarr v3, matching the format of the input data.",
          "example" : [
            "output.h5mu"
          ],
          "must_exist" : true,
