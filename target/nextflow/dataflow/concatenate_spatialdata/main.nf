// concatenate_spatialdata build_bump_spatialdata
// 
...
meta = [
  ...
  "argument_groups" : [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--inputs",
          "description" : "Paths to Zarr stores containing the SpatialData objects to concatenate.\n",
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
          "direction" : "input",
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--output",
          "description" : "The output Zarr store containing the concatenated SpatialData object.\n",
          "default" : [
            "output.zarr"
          ],
          "must_exist" : true,
    ...
    },
    {
      ...
      "description" : "Options for how to concatenate the SpatialData objects, passed to\n`spatialdata.concatenate`.\n",
      "arguments" : [
        {
          "type" : "string",
          "name" : "--attrs_merge",
          "description" : "The method to use for merging elements in `attrs` when concatenating\nthe SpatialData objects. See `anndata_merge` for options and details.\n",
          "required" : false,
          "choices" : [
            "same",
            "unique",
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--anndata_label",
          "description" : "The name of the column in `obs` of the concatenated main table to\nstore batch label information. If not provided, no batch label column\nis added.\n",
          "example" : [
            "sample"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Whether pairwise elements (`obsp`/`varp`) are concatenated.\n",
          "default" : [
            false
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/dataflow/concatenate_spatialdata/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  'inputs': $( if [ ! -z ${VIASH_PAR_INPUTS+x} ]; then echo "r'${VIASH_PAR_INPUTS//\\'/\\'\\"\\'\\"r\\'}'.split(',')"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'attrs_merge': $( if [ ! -z ${VIASH_PAR_ATTRS_MERGE+x} ]; then echo "r'${VIASH_PAR_ATTRS_MERGE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'anndata_join': $( if [ ! -z ${VIASH_PAR_ANNDATA_JOIN+x} ]; then echo "r'${VIASH_PAR_ANNDATA_JOIN//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'anndata_merge': $( if [ ! -z ${VIASH_PAR_ANNDATA_MERGE+x} ]; then echo "r'${VIASH_PAR_ANNDATA_MERGE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'anndata_uns_merge': $( if [ ! -z ${VIASH_PAR_ANNDATA_UNS_MERGE+x} ]; then echo "r'${VIASH_PAR_ANNDATA_UNS_MERGE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'anndata_label': $( if [ ! -z ${VIASH_PAR_ANNDATA_LABEL+x} ]; then echo "r'${VIASH_PAR_ANNDATA_LABEL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'anndata_pairwise': $( if [ ! -z ${VIASH_PAR_ANNDATA_PAIRWISE+x} ]; then echo "r'${VIASH_PAR_ANNDATA_PAIRWISE//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/dataflow/concatenate_spatialdata",
