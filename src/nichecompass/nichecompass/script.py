...
model = NicheCompass(
  ...
  include_cat_covariates_contrastive_loss=par["include_cat_covariates_contrastive_loss"],
...
model.train(
  ...
  n_epochs_no_cat_covariates_contrastive=par["n_epochs_no_cat_covariates_contrastive"],
  lr=par["lr"],
