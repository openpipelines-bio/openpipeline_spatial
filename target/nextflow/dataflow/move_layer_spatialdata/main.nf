// move_layer_spatialdata build_bump_spatialdata
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Name of the layer to move. If not provided, X will be moved.\n",
          "example" : [
            "old_layer"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/dataflow/move_layer_spatialdata/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  ...
  'delete_input_layer': $( if [ ! -z ${VIASH_PAR_DELETE_INPUT_LAYER+x} ]; then echo "r'${VIASH_PAR_DELETE_INPUT_LAYER//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/dataflow/move_layer_spatialdata",
