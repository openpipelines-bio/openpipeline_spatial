// xenium_spatial_statistics build_bump_spatialdata
// 
...
meta = [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input",
          "description" : "A MuData file containing spatial transcriptomics data and a\npre-computed spatial neighborhood graph in `.obsp`.\n",
          "example" : [
            "input.h5mu"
          ],
          "must_exist" : true,
        ...
        },
        {
          "type" : "string",
          "name" : "--modality",
          "description" : "The name of the modality to use from the MuData object.\nThis specifies which AnnData object contains the spatial data.\n",
          "default" : [
            "rna"
          ],
          "required" : true,
        ...
        },
        {
          ...
          "description" : "The key in `.obsm` where spatial coordinates are stored.\nExpected shape is (n_cells, 2) for 2D coordinates.\n",
          "default" : [
            "spatial"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--output",
          "description" : "The output MuData file with calculated spatial statistics.\nPer-cell metrics are stored in `.obs` and global statistics in `.uns`.\n",
          "default" : [
            "output.h5mu"
          ],
          "must_exist" : true,
        ...
        },
        {
          "type" : "string",
          "name" : "--output_prefix",
          "description" : "Prefix to add to all generated column names in `.obs`.\n",
          "default" : [
            "spatial_"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          ...
          "description" : "Bandwidth parameter for Gaussian kernel density estimation in spatial units\n(typically microns). Larger values create smoother density estimates.\n",
          "default" : [
            50.0
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_spatial/openpipeline_spatial/src/feature_annotation/xenium_spatial_statistics/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  ...
  'obsm_spatial_coordinates': $( if [ ! -z ${VIASH_PAR_OBSM_SPATIAL_COORDINATES+x} ]; then echo "r'${VIASH_PAR_OBSM_SPATIAL_COORDINATES//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_prefix': $( if [ ! -z ${VIASH_PAR_OUTPUT_PREFIX+x} ]; then echo "r'${VIASH_PAR_OUTPUT_PREFIX//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'density_bandwidth': $( if [ ! -z ${VIASH_PAR_DENSITY_BANDWIDTH+x} ]; then echo "float(r'${VIASH_PAR_DENSITY_BANDWIDTH//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'calculate_ripley_l': $( if [ ! -z ${VIASH_PAR_CALCULATE_RIPLEY_L+x} ]; then echo "r'${VIASH_PAR_CALCULATE_RIPLEY_L//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'n_subsample_ripley': $( if [ ! -z ${VIASH_PAR_N_SUBSAMPLE_RIPLEY+x} ]; then echo "int(r'${VIASH_PAR_N_SUBSAMPLE_RIPLEY//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_spatial/feature_annotation/xenium_spatial_statistics",
