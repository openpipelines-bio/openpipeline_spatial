...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/workflows/rna/rna_singlesample/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/nextflow/workflows/rna/rna_singlesample",
    "viash_version" : "0.9.4",
